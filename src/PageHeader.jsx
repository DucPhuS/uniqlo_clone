...
export default function PageHeaders(){
    ...
    <div className='relative'>
        <div className='pt-3 z-10 bg-black'>
            <nav className="pt-0 z-10 bg-transparent ml-auto mr-auto h-auto max-w-custom w-custom">
                <div className='relative flex flex-row align-top items-center h-auto bg-transparent'>
                    ...
                    <div className="relative flex flex-row ml-auto flex-grow-0">
                        <div className='inline-flex flex-col justify-center h-[44px] min-w-[44px] mr-2 p-1'>
                            <Link>
                                <svg className='size-[24px] text-white hover:text-[#6a6a6a]' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
